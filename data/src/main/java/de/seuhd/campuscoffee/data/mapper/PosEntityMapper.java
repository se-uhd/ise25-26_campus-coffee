...
public interface PosEntityMapper extends EntityMapper<Pos, PosEntity> {
     ...
     * @return the JPA entity, or null if the source is null
     */
    @Override
    ...
    default AddressEntity splitHouseNumber(Pos source, AddressEntity addressEntity) {
        ...
        if (!numericPart.isEmpty()) {
            ...
            throw new IllegalArgumentException(
                    "Invalid house number '" + source.houseNumber() + "': must contain at least one digit."
            );
        }
